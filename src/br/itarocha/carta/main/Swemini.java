...
snam=null; // Realistisch?
    ...
    iflag = SweConst.SEFLG_SPEED | SweConst.SEFLG_MOSEPH;
...
//      if (sscanf (sdate, "%d%*c%d%*c%d", &jday,&jmon,&jyear) < 1) exit(1);
      ...
      System.out.print("date: "+String.format("%02d",jday)+"."+String.format("%02d",jmon)+"."+
      ...
      for (p = SweConst.SE_SUN; p <= SweConst.SE_CHIRON; p++) {
         ...
         */
        System.out.print(String.format("%10s",snam)+"\t"+String.format("%11.7f",x2[0])+"\t"+
        		String.format("%10.7f",x2[1])+"\t"+String.format("%10.7f",x2[2])+"\t"+
        		String.format("%10.7f",x2[3])+"\n");
        /*
